...
export const H1Tag: Function = styled.h1`
...
export const H1TagGreen: Function = styled.h1`
...
export const H1TagRed: Function = styled.h1`
  font: 900 2em/2rem ${fonts.header};
  color: ${colors.red};
  @media (max-width: ${deviceSizes.mobile}) {
    font: 900 1.4em/1.4rem ${fonts.header};
...
export const H2Tag: Function = styled.h2`
  font: 900 1.1em/1.1rem ${fonts.header};
  color: ${colors.secondary};
  line-height: 1rem;
`;

export const H3Tag: Function = styled.h3`
  font: 900 1.8em/1.8rem ${fonts.header};
  color: ${colors.red};
  line-height: 1rem;
`;

export const H4Tag: Function = styled.h4`
